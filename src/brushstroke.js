...
const brushstroke = () => {
  ...
  function setPosition(o) {
    let elRect = o.el.getBoundingClientRect();
    let rootRect = o.root.getBoundingClientRect();
  ...
  function resizeImage(img, o) {
    ...
    if (o.stretch) {
      ...
      let left = o.width / 2 - width / 2;
      let top = o.height / 2 - height / 2;
  ...
  Brushstroke.prototype = {
    ...
    run: function (options) {
      ...
      if (options.clear) {
        ...
        // else {
        //   let html = '<style>body{margin:0;}</style>' + getOuterHTML(options.el);
